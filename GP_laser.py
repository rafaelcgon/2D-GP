...
def laser(ts=20,nsteps=8,l_df=5,l_cf=5,tau=1,rate=0.5,noise = 0.0025,nsamples=1):
# Hyperparameters:
# 	l_df  : decorreltaion length divergence free kernel
# 	l_cf  : decorrelation lenth curl-free kernel 
# 	tau   : decorrelation time (for now use in both kernels) 
# 	rate  : weight for div-free kernel (the other is 1 - rate) 
# 	noise : observation 
...
def laser2(ts=20,nsteps=8,l_df=5,l_cf=5,tau=1,rate=0.5,noise = 0.0025,nsamples=1):
# Hyperparameters:
# 	l_df  : decorreltaion length divergence free kernel
# 	l_cf  : decorrelation lenth curl-free kernel 
# 	tau   : decorrelation time (for now use in both kernels) 
